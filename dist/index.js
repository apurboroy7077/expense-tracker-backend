...
app_1.default.listen(environment_variable_1.SOCKET_SERVER_PORT, () => {
    console.log(`Socket and Express both server is running on http://localhost:${environment_variable_1.SOCKET_SERVER_PORT}`);
    setInterval(() => {
